 ...
 */
public abstract class XC_MethodAfterReplacement extends XC_MethodHook {
    /**
     * Creates a new callback with default priority.
     */
    public XC_MethodAfterReplacement() {
        super();
    }
     ...
     */
    public XC_MethodAfterReplacement(int priority) {
        super(priority);
    }
     ...
     */
    public static final XC_MethodAfterReplacement DO_NOTHING = new XC_MethodAfterReplacement(PRIORITY_HIGHEST * 2) {
        @Override
     ...
     */
    public static XC_MethodAfterReplacement returnConstant(final Object result) {
     ...
     * @param result   The value that should be returned to callers of the hooked method.
     */
    public static XC_MethodAfterReplacement returnConstant(int priority, final Object result) {
        return new XC_MethodAfterReplacement(priority) {
            @Override
            protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                return result;
            }
